...
import { FOOTER_STATS, COMPANY, CONTACT } from '../data/siteConstants'
              ...
              <ul className="space-y-4">
                <li className="flex gap-3 items-start">
                  ...
                  <span className="text-theme-fg-3 text-xs leading-relaxed font-sans">
                    {COMPANY.name}<br />
                    {CONTACT.address1}<br />
                    {CONTACT.city}, {CONTACT.state.slice(0, 2).toUpperCase()} {CONTACT.pincode}
                  </span>
                </li>
                <li>
                  <a href={CONTACT.phoneTel} className="flex gap-3 items-center text-theme-fg-3 text-xs hover:text-[#52B788] transition-colors font-sans">
                ...
                <li>
                  <a href={`mailto:${CONTACT.email}`} className="flex gap-3 items-start text-theme-fg-3 text-xs hover:text-[#52B788] transition-colors break-all font-sans">
                    <svg className="w-4 h-4 text-[#52B788] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
