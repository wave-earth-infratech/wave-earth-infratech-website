                    ...
                    <div className="col-lg-6 col-md-12">
                        <div className="right-footer-wrapper-3 pt--120 pb--80 pl--120 pr--120 pl_md--0 pt_md--30 pl_sm--0 pt_sm--30">
                            <div className="single-information">
                                ...
                                <a href="#" className="address" data-sal="slide-up" data-sal-delay="350" data-sal-duration="800" >
                                    Kingstone --- <br/>
                            ...
                            <div className="single-information">
                                ...
                                <a href="mailto:name@email.com" className="mail" data-sal="slide-up" data-sal-delay="350" data-sal-duration="800" >
                                    hello@design.com
                                </a>
                                <a href="tel:+18475555555" className="number" data-sal="slide-up" data-sal-delay="550" data-sal-duration="800" >
                                    +258 368 3158
                                </a>
                            </div>
                        </div>
