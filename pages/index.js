            ...
            {(featuredProjects.length > 0 ? featuredProjects.slice(0, 4) : [
              ...
              <div key={project.title} className={`group flex flex-col lg:flex-row bg-theme-card overflow-hidden ${idx % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
                ...
                <div className="flex-1 p-8 lg:p-12 flex flex-col justify-center">
                  ...
                  {project.slug ? (
                    <Link href={`/projects/${project.slug}`} className="self-start text-[#52B788] text-xs font-semibold uppercase tracking-widest hover:text-white transition-colors flex items-center gap-2 group/link">
                    ...
                    <Link href="/projects" className="self-start text-[#52B788] text-xs font-semibold uppercase tracking-widest hover:text-white transition-colors flex items-center gap-2 group/link">
      ...
      <section className="relative py-28 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="https://wa.me/912583683158?text=Hello%2C%20I%20am%20enquiring%20about%20your%20infrastructure%20services." target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white font-semibold text-xs uppercase tracking-widest px-8 py-4 hover:bg-[#1db954] transition-colors duration-200 min-w-[200px]">
