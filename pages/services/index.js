  ...
  return (
    <>
      ...
      <main className="bg-[#040c18] text-white min-h-screen">
        ...
        {/* ── Stats bar ── */}
        <div className="border-b border-white/[0.06] bg-[#040c18]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-px bg-white/[0.06]">
              {services.map((service, i) => (
                <Link
                  ...
                  className="group relative flex flex-col p-8 bg-[#040c18] hover:bg-[#071526] transition-all duration-300 overflow-hidden"
                >
                  ...
                  {/* Icon */}
                  <div className="w-12 h-12 border border-white/10 group-hover:border-[#52B788]/50 flex items-center justify-center mb-6 transition-colors">
                    {icons[service.slug]}
                  </div>

                  <h3 className="font-display text-[20px] text-white uppercase tracking-wide mb-2 group-hover:text-[#52B788] transition-colors leading-tight">
                    {service.name}
                  </h3>
                  <p className="text-gray-500 text-sm leading-relaxed mb-6 flex-1 font-sans">
                    {service.tagline}
                  </p>
        ...
        {/* ── Why choose us strip ── */}
        <section className="py-16 bg-[#050d1a] border-t border-white/[0.06]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/[0.06]">
              {[
                ...
                <div key={title} className="bg-[#040c18] px-10 py-10">
                  <span className="w-6 h-px bg-[#52B788] block mb-5" />
                  <h3 className="font-display text-[20px] text-white uppercase tracking-wide mb-3">{title}</h3>
                  <p className="text-gray-500 text-sm leading-relaxed font-sans">{body}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* ── CTA ── */}
        <section className="py-24 bg-[#040c18] border-t border-white/[0.06]">
          <div className="max-w-3xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a
                ...
                className="flex items-center gap-2 text-gray-400 hover:text-white text-sm font-sans transition-colors"
              >
